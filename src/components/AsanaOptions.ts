export const caseSuiteOptions = ['即檢及列印', '身分設定', 'SOAP', '下診斷ICD', '藥囑', '醫囑',
...
export const manualTestCoverageOptions = ['Smoke', 'Quick', 'Partial', 'Full',
'Backlog', 'DefectVerify', 'FectureVerify', 'E2E', 'Use Case', 'Offline'];

export const manualTestEnvironmentOptions = ['INTT', 'STAGE', 'PROD', 'DEV'];
